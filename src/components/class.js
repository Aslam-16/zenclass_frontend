    ...
    <div class="panel-heading active" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a  role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
         <span>Webinar On Full Stack Development</span><span class="size"style={{marginLeft: 242}}>15/2/2021</span> <span style={{paddingLeft:70}}><button  type="button" class="click">Register Now</button></span><br/>
         <span class="presenter">by Aslam Ceo,Mytech services Alaska</span><span class="size" style={{marginLeft: 290}}>03.00pm</span>
        </a>
...
<div class="row">
    ...
    <div class="col-sm-6">
     ...
     <span><ol style={{width:360,textAlign:'left'}}><li>What is Full Stack Development</li>
    ...
    <div class="col-sm-6" >
     <span style={{float:"left"}}>A.Mohamed Aslam</span><br/>
       <span style={{float:"left"}}>Ceo,Mytech services Alaska</span>  
    </div>
  </div>
...
<div class="row">
    ...
    <div class="col-sm-6" ><img class="topnav2" src="guvi.png"/>
      <p class="alignment">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto.   </p>
    </div>
    <div class="col-sm-6" >
     <span style={{float:"left"}}>A.Mohamed Aslam</span><br/>
